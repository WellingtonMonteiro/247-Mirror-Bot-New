...
class DbManger:
    ...
    def db_unauth(self,chat_id: int):
        ...
        return 'Unauthorization Success'
    ...
    def db_addsudo(self,chat_id: int):
        ...
        if chat_id in AUTHORIZED_CHATS:
            ...
            return 'Successfully promoted as Sudoku'
        else:
            ...
            self.disconnect()
            SUDO_USERS.add(chat_id)
            return 'Successfully Authorized and promoted as Sudoku'
    ...
    def db_rmsudo(self,chat_id: int):
        ...
        return 'Successfully removed from Sudoku'
