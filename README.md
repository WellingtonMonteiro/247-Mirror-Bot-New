```diff 
- [ LIVE REPO AND YES MORE UPDATE ]
```
![Luna-mirror](https://telegra.ph/file/b32a9d3863c614e8d9e2a.jpg)
...
**ZXMIKAR Mirror Bot** is a _multipurpose_ Telegram Bot written in Python for mirroring files on the Internet to our beloved Google Drive. Based on [python-aria-mirror-bot](https://github.com/lzzy12/python-aria-mirror-bot)
